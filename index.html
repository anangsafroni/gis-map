...
<tr><td>Luas Area Bencana</td><td>: <input type="text" name="areabencana" id="areabencana"></td></tr>
<tr><td>Jumlah Korban</td><td>: <input type="text" name="jumlahkorban" id="jumlahkorban"></td></tr>
